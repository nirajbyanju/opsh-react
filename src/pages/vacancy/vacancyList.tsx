...
const VacancyList = () => {
  ...
  return (
    <div className="px-4">
      ...
      <div className="bg-opsh-primary/5 mt-5 rounded-lg overflow-x-auto scrollbar-hide">
        <ul className="flex gap-1 text-sm font-medium text-center text-opsh-darkgrey whitespace-nowrap">
          <li className="border-b-2 border-opsh-secondary">
            <button className="inline-flex items-center justify-center py-3 px-5 gap-3 hover:text-opsh-secondary hover:border-opsh-secondary">
