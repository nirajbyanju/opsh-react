    ...
    <div className="w-full mx-auto bg-white sm:py-4 sm:px-4 lg:px-10 rounded-lg shadow">
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row items-center mb-4 gap-4">
          ...
          <button
            className="border-opsh-primary  rounded-full border border-spacing-2 text-opsh-primary px-4 py-2"
        ...
        <table className="w-full table-auto border-collapse">
          ...
          <tbody>
            <tr className="odd:bg-white even:bg-gray-50">
              <td className="p-4 text-center text-sm">Opportunities Sharing</td>
              <td className="p-4 text-center text-sm">UI/UX Designer</td>
              <td className="p-4 text-center text-sm">
                Lorem ipsum dolor ddel sdlks akss
              </td>
              <td className="p-4 text-center text-sm">10/10/2020</td>
              <td className="p-4 text-center text-sm">10/10/2020</td>
              <td className="p-4 text-center text-sm">5 Year</td>
              <td className="p-4 text-center text-sm">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row items-center mb-4 gap-4">
          ...
          <hr className="border-t-1 border-opsh-primary flex-grow sm:ml-4 mt-2 sm:mt-0 w-full sm:w-auto" />
          <button className="border-opsh-primary  rounded-full border border-spacing-2 text-opsh-primary px-4 py-2">
            + Add Data in Table
          </button>
        </div>
        <table className="w-full table-auto border-collapse">
