...
const Modal: FC<ModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Collect form data and pass to onSubmit callback
    const formData = {
        ...
        "
          ...
          <div className="grid gap-y-2">
            <div className="grid grid-cols-1 gap-y-2 gap-x-3 sm:grid-cols-1 md:grid-cols-3">
              ...
              <div>
                <label className="block text-sm mb-1 text-opsh-primary font-medium">
                  Level
                </label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 gap-y-2 gap-x-3 sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="grid grid-cols-1 gap-y-2 gap-x-3 sm:grid-cols-1 md:grid-cols-3 mt-2">
            <div>
              <label
